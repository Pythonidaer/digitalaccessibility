  ...
  const SECTIONS = {
    'core-concepts': {
      ...
      pages: [
        ...
        { path: 'core-concepts/wcag-overview.html', title: 'W.C.A.G. Overview' },
    ...
    practice: {
      ...
      pages: [
        ...
        { path: 'practice/quizzes/wcag-basics.html', title: 'Quiz: W.C.A.G. Basics' },
    ...
    reference: {
      ...
      pages: [
        ...
        { path: 'core-concepts/accessibility-specialist-role.html', title: 'Accessibility Specialist Role (skills & interview)' },
